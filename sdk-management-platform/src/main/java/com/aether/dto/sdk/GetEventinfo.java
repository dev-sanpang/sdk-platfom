...
public class GetEventinfo {
	private List<GetEventAndCount> eventCounts;
	...
	public List<GetEventAndCount> getEventCounts() {
		return eventCounts;
	}

	public void setEventCounts(List<GetEventAndCount> eventCounts) {
	...
	public void setSubsessionCount(Integer subsessionCount) {
